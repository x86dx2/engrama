...
# CONCLUÍDA em .engrama/evidence/qa/criticas-do-executor.md, por CATEGORIA, referenciando
...
# reexecuta este gate contra o PR (.engrama/engine/scripts/critique-gate-ci.sh), calculando o
...
# 3. Ative o hook: git config core.hooksPath .engrama/engine/githooks  (e/ou PreToolUse no harness).
# ──────────────────────────────────────────────────────────────────────────────
set -u
...
classify() {
  ...
  case "$f" in
    ...
    template/.engrama/memory/governance/*|template/.engrama/memory/decisions/*|template/.engrama/memory/specs/*|template/.engrama/memory/project/*|template/.engrama/evidence/qa/*) addcat governance ;;
    ...
    .engrama/engine/scripts/*.sh|.engrama/engine/githooks/*|.claude/settings.json) addcat gate ;;
    .github/*) addcat gate ;;
    template/.engrama/engine/scripts/*.sh|template/.engrama/engine/githooks/*|template/.claude/settings.json) addcat gate ;;
...
DIFF_HASH_SCRIPT="$REPO_ROOT/.engrama/engine/scripts/engrama-diff-hash.sh"
...
LEDGER=".engrama/evidence/qa/criticas-do-executor.md"
