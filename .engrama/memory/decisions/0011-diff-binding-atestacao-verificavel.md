...
source_refs:
  ...
  - .engrama/memory/gaps/auditoria-e-plano-de-remediacao.md
---
...
O plano de remediação já apontava o próximo passo: vincular a prova ao diff, sem cair em autorreferência (o ledger não pode entrar no próprio hash). Ver [[memory/gaps/auditoria-e-plano-de-remediacao]].
...
- Fecha a etapa de diff-binding prevista em [[memory/gaps/auditoria-e-plano-de-remediacao]].
