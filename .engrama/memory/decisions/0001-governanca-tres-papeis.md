...
> Template: defina o mapeamento atual em [[memory/governance/papeis-e-alcadas]] (`Claude (Claude Code)` / `Codex` / `Humano (preencher)`). Vale qualquer combinação de agentes/pessoas, desde que o separador **escritor ≠ auditor** e a **arbitragem humana de impasse** se mantenham.
