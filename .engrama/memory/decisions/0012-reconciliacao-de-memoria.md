...
type: decision
status: active
touches: [memory/decisions/0005-orquestrador-qa-reexecucao-e-metricas, memory/decisions/0006-governanca-nao-se-autoaprova, memory/gaps/metricas-de-engrama]
date: 2026-06-21
source_refs:
  - .engrama/CLAUDE.md
  - .engrama/engine/scripts/lint.sh
  - tests/contract/lint.test.sh
reconcilia: ADD
---
