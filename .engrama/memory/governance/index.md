...
- **Executor-bridge automatizado:** o **Orquestrador invoca o Executor diretamente** (`codex exec`) e fecha o loop até staging sozinho, sem relay humano de rotina. Ver [[memory/decisions/0003-executor-bridge-orquestrador-invoca-executor]].
