...
Template da **ordem ao Executor** (executor-bridge). Toda invocação `codex exec` segue isto. Detalhe normativo: [[memory/governance/continuidade-de-sessao]] (ordem mínima) + [[memory/decisions/0010-roteamento-modelo-effort-do-executor]] (tier).
