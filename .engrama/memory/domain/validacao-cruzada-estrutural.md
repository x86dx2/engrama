...
type: domain
status: active
touches: [memory/decisions/0001-governanca-tres-papeis, memory/decisions/0004-executor-critica-ativa-discordancia-escala-a-autoridade, memory/decisions/0006-governanca-nao-se-autoaprova, memory/decisions/0011-diff-binding-atestacao-verificavel, evidence/qa/criticas-do-executor]
date: 2026-06-21
source_refs:
  - .engrama/memory/decisions/0001-governanca-tres-papeis.md
  - .engrama/memory/decisions/0004-executor-critica-ativa-discordancia-escala-a-autoridade.md
  - .engrama/memory/decisions/0006-governanca-nao-se-autoaprova.md
...
- [[memory/decisions/0001-governanca-tres-papeis]] separa estruturalmente **Orquestrador**, **Executor** e **Autoridade**.
- [[memory/decisions/0004-executor-critica-ativa-discordancia-escala-a-autoridade]] transforma o Executor em **freio ativo**; objeção material não volta para o Orquestrador como mera sugestão.
- [[memory/decisions/0006-governanca-nao-se-autoaprova]] exige que governança e superfícies sensíveis passem pela crítica registrada em [[evidence/qa/criticas-do-executor]] antes do commit.
- [[memory/decisions/0011-diff-binding-atestacao-verificavel]] liga essa crítica ao **diff exato** quando há `sha256`, evitando que um "confirmo" antigo libere qualquer mudança futura da branch.
...
2. **Há gate mecânico, não só disciplina verbal.**
   - `.engrama/engine/scripts/critique-gate.sh` cobra branch + categoria + veredito no ledger.
   - O ledger [[evidence/qa/criticas-do-executor]] torna a crítica um artefato verificável do processo.
3. **Há vínculo opcional ao conteúdo do diff.**
   - O `sha256` de [[memory/decisions/0011-diff-binding-atestacao-verificavel]] prova que a crítica cobria **este diff**, não um diff qualquer.
...
Ver também [[memory/domain/escopo-e-identidade]] e [[memory/domain/ponto-de-vista-e-representacao]].
