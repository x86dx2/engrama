...
type: domain
status: active
touches: [memory/specs/orquestrador, memory/governance/papeis-e-alcadas, memory/governance/cadeia-de-comando, evidence/qa/criticas-do-executor, memory/decisions/0011-diff-binding-atestacao-verificavel]
date: 2026-06-21
source_refs:
...
- [[memory/specs/orquestrador]] descreve como o Orquestrador deveria operar;
- [[memory/governance/papeis-e-alcadas]] declara quem faz o quê;
- [[memory/governance/cadeia-de-comando]] fixa como a objeção e a arbitragem deveriam fluir.
...
- na resposta crítica do Executor, cujo protocolo em [[memory/governance/continuidade-de-sessao]] admite `concordo | ajuste-menor | discordo`;
- no ledger [[evidence/qa/criticas-do-executor]], que registra a projeção commit-oriented dessa observação (`confirmo`, `ressalvas`, `waiver`, `dispensada` e equivalentes aceitos pelo gate).
