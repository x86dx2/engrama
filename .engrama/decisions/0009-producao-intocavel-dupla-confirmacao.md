...
## Consequências
- Quando o projeto tiver alvo de deploy (stack-alvo: `Markdown + Bash + Git hooks + Claude Code settings`), esta ADR vira `active` e a matriz de alçadas ativa os gates de prod/staging.
