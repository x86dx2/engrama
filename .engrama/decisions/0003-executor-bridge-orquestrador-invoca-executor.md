...
## Decisão
- O Orquestrador monta a **ordem mínima** (ver [[governance/continuidade-de-sessao]]) e chama `codex exec --model <tier> [--output-schema]`.
...
**mecanizado**:
- `.engrama/scripts/exec-bridge.sh` invoca `codex exec --json`, salva a **ordem verbatim** em
  `.engrama/transcripts/<data>-<label>-order.md` e a **resposta íntegra** em
  `.engrama/transcripts/<data>-<label>-response.md`.
