...
Este repo tem dois papeis: **instancia viva** do Engrama na raiz e **template distribuivel** em `template/`. A fonte de verdade do bootstrap deste proprio projeto e `.engrama/project/bootstrap-do-projeto.md`.
