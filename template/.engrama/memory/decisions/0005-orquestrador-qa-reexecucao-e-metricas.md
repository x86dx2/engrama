...
type: decision
status: active
touches: [memory/governance/papeis-e-alcadas, memory/governance/cadeia-de-comando, 0002-orquestrador-dono-do-git-executor-escreve]
date: {{DATA}}
source_refs:
  - CLAUDE.md
---
...
- O Orquestrador **não escreve teste de fatia** (isso é do Executor, sob a spec do Orquestrador — preserva [[memory/decisions/0002-orquestrador-dono-do-git-executor-escreve]]); o Orquestrador **roda para garantir**.
