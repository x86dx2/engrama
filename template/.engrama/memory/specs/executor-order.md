...
> Exemplo (troque pelo do seu projeto): o item 4 (fronteiras) é onde o Orquestrador isola o sistema legado e a produção. Num projeto que migra de uma base anterior, valeria escrever algo como "não tocar no app legado em `{{DEV_URL}}`, não tocar em código de produção, não tocar fora da fatia X" — adapte os alvos concretos ao seu layout.
