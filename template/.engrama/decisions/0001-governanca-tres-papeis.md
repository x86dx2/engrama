...
> Template: defina o mapeamento atual em [[governance/papeis-e-alcadas]] (`{{ORQUESTRADOR}}` / `{{EXECUTOR}}` / `{{AUTORIDADE}}`). Vale qualquer combinação de agentes/pessoas, desde que o separador **escritor ≠ auditor** e a **arbitragem humana de impasse** se mantenham.
