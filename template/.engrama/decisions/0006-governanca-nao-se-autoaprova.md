...
1. Antes de comitar mudança que toque essas superfícies, a **crítica do Executor ({{MODELO_CRITICA}}, read-only)** é obrigatória e registrada em [[qa/criticas-do-executor]] (por categoria, citando a branch).
