...
Cada invocacao via `.engrama/scripts/exec-bridge.sh` gera um par datado em `.engrama/transcripts/`:

```
.engrama/transcripts/<YYYY-MM-DD>-<label>-order.md      # a ordem (verbatim)
.engrama/transcripts/<YYYY-MM-DD>-<label>-response.md   # a resposta do codex (integra) + cabecalho YAML
```
