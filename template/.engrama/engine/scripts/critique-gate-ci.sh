...
GATE_REL=".engrama/engine/scripts/critique-gate.sh"
LEDGER_REL=".engrama/evidence/qa/criticas-do-executor.md"
...
usage() {
  cat <<'EOF'
Uso: bash .engrama/engine/scripts/critique-gate-ci.sh --branch <nome-da-branch> --base-ref <gitish> --files-from <arquivo-nul>
