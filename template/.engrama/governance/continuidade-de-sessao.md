...
1. Ler a ordem mínima de [[governance/index]] (papéis → cadeia → modelo → continuidade → ADRs → topo do [[log]]).
2. Identificar **seu papel** ([[governance/papeis-e-alcadas]]) e o que a alçada permite.
3. Ler [[project/bootstrap-do-projeto]] e verificar se o bootstrap do projeto está concluído.
...
- **Memória fria** = `governance/`, `decisions/`, `specs/` e as páginas duráveis de domínio do seu projeto. Ela muda devagar e por revisão explícita.
